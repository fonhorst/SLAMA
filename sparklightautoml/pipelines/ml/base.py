...
from ...computations.manager import WorkloadType, ComputationsManager, default_computations_manager
...
class SparkMLPipeline(LAMAMLPipeline, TransformerInputOutputRoles):
    ...
    def fit_predict(
        ...
        with train_valid.frozen() as frozen_train_valid:
            ...
            results = self._computations_manager.compute2(fit_tasks, workload_type=WorkloadType.ml_algos)
